...
@Model class PlaybackSource {
    @Attribute(.unique)
    var id = UUID()

    var rawTransform: [Float]! = nil

    @Transient var transform: simd_float4x4 {
        get {
            // swift-format-ignore
...
@Model class SoundEventAsset {
    ...
    @Transient var playbackMode: PHASEPlaybackMode {
